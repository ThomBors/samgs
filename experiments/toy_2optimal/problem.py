...
class Toy(nn.Module):
    ...
    def Function1(self, x1, x2, compute_grad=False):
        ...
        f1_sq = ((0.1*((x1-5.45)/4).pow(6)+0.1*((x2)/4).pow(6)) - (((x1-5.5)/4).pow(4)+((x2)/4).pow(4)) -(1.5*((x1-5.5)/4).pow(2)+ 1.5*((x2)/4).pow(2))) + 1.5
    ...
    def Function2(self, x1,x2, compute_grad=False):
        ...
        c2 = torch.clamp(torch.tanh(-x2 * 0.5), 0)
        f2_sq = ((0.1*((x1+5.45)/4).pow(6)+0.1*((x2)/4).pow(6)) - (((x1+5.5)/4).pow(4)+((x2)/4).pow(4)) -(1.5*((x1+5.5)/4).pow(2)+ 1.5*((x2)/4).pow(2))) + 1.5
